...
<p align="center">
 <img src="2023.png?raw=true" alt="90-Days-of-DevOps-as-a-Learning Logo" width="50%" height="50%" />
</p>
...
Ou nous contacter via twitter : [@nholuong](https://twitter.com/nholuong) Vous pouvez trouver les auteurs des différentes parties de cette édition 2023 dans le tableau suivant
...
| Topic                                  | Author                              | Date                | Handle                                                                                  |
| -------------------------------------- | ----------------------------------- | ------------------- | ----------------------------------------------------------------------------------------------- |
| DevSecOps                              | nholuong                             | 1st Jan - 6th Jan   | 
[@nholuong][Github](https://github.com/nholuongut/)                                              |
| Secure Coding                          | nholuong                             | 7th Jan - 13th Jan  | 
[@nholuong](https://www.linkedin.com/in/nholuong/)                                          |
