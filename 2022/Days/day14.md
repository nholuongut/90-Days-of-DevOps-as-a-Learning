...
> If you are using m1 macOS, I recommend to use [multiplass]([url](https://multipass.run/)) instead of Vagrant and VirtualBox. (reference : https://github.com/nholuongut/90-Days-of-DevOps-as-a-Learning/issues/365)
