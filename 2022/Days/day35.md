...
I have started using version control over not just source code but pretty much anything, talks about projects like this (90-Days-of-DevOps-as-a-Learning). Why not accept the features that rollback and log of everything that has gone on. 
