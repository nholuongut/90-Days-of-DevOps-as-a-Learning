...
이를 실행하려면 `./create_user.sh nholuong`을 사용하십시오. nholuong 대신에 당신의 이름을 사용하세요.
...
두 개의 파라미터로 이 스크립트를 실행하려면 `./create_user.sh 90-Days-of-DevOps-as-a-Learning password`를 사용하세요.
