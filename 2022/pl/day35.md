...
I have started using version control over not just source code but pretty much anything that talks about projects like this (90-Days-of-DevOps-as-a-Learning) because why would you not want that rollback and log of everything that has gone on. 
...
The primary reason if you have not picked up so far for version control, in general, is the ability to collaborate. The ability to share code amongst developers and when I say code as I said before more and more we are seeing much more use cases for other reasons to use source control, maybe its a joint presentation you are working on with a colleague or a 90-Days-of-DevOps-as-a-Learning challenge where you have the community offering their corrections and updates throughout the project. 
