...
First up we need to enter a path to what we want to snapshot and our case we want to take a copy of our `90-Days-of-DevOps-as-a-Learning` folder. We will get back to the scheduling aspect shortly. 
