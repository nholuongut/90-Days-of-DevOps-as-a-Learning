...
*MySQL is an open-source relational database management system. Its name is a combination of "My", the name of co-founder nholuong Widenius's daughter, and "SQL", the abbreviation for Structured Query Language.*
