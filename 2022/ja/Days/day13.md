---
title: '#90-Days-of-DevOps-as-a-Learning - 新しいアプリで進捗をツイート - 13日目'
published: false
description: 90-Days-of-DevOps-as-a-Learning - 新しいアプリで進捗をツイート
...
メインアプリケーションに組み込む前にテストするために、`src` フォルダに go-twitter-bot という新しいディレクトリを作成し、そのフォルダに対して `go mod init github.com/nholuongcade/go-twitter-bot` を実行すると `go.mod` ファイルが作成され、新しい main.go を書いてこれをテストできるようになりました。
...
これは、あなたが現在 [リポジトリ](https://github.com/nholuongut/90-Days-of-DevOps-as-a-Learning/releases)で見ることができるリリースを作成するために使用したものです。
