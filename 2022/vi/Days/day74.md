...
Chúng ta có [GitHub repository](https://github.com/nholuongCade/Jenkins-HelloWorld) đang chứa Dockerfile và tệp index.html
...
Để tham khảo, chúng ta sẽ sử dụng `https://github.com/nholuongCade/Jenkins-HelloWorld.git` làm URL của kho lưu trữ.
...
Một thứ tôi đã thay đổi trong bài trước đó là tôi muốn tải ảnh tới một kho lưu trữ công cộng đó là nholuong\90-Days-of-DevOps-as-a-Learning, Jenkinsfile của tôi đã có thay đổi này từ trước. Và từ bài trước, tôi đã gỡ toàn bộ các ảnh container demo.
